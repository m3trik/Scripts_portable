...
class TkWidget_MultiWidget(QtWidgets.QWidget, Attributes):
	'''
	:Parameters:
	...
	def eventFilter(self, widget, event):
		...
		return super(TkWidget_MultiWidget, self).eventFilter(widget, event)
...
if __name__ == "__main__":
	...
	w = TkWidget_MultiWidget(set_by_value=['Height', 0])
