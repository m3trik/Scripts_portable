...
class Subdivision(Init):
	def __init__(self, *args, **kwargs):
		...
		self.subdivision.gb000.setTitle('TurboSmooth')
		self.subdivision.s000.setPrefix('Iterations:  ')
		self.subdivision.s001.setPrefix('RenderIters: ')
		self.subdivision.s000.setValue(0)
		self.subdivision.s001.setValue(0)
	...
	def s000(self, value=None):
		'''Division Level
		'''
		value = self.subdivision.s000.getValue()
	...
	def s001(self, value=None):
		'''Tesselation Level
		'''
		value = self.subdivision.s001.getValue()
