...
class Symmetry(Init):
	def __init__(self, *args, **kwargs):
		...
		# if axis == "x":
		# 	self.symmetry.chk000.setChecked(state)
		# if axis == "y":
		# 	self.symmetry.chk001.setChecked(state)
		# if axis == "z":
		# 	self.symmetry.chk002.setChecked(state)


	def draggable_header(self, state=None):
		'''Context menu
		'''
		draggable_header = self.symmetry.draggable_header
	...
	def setSymmetry(self, state, axis):
		...
		# if self.symmetry.chk004.isChecked(): #object space
		# 	space = "object"
		# elif self.symmetry.chk005.isChecked(): #topological symmetry
		# 	space = "topo"
	...
	def chk004(self, state=None):
		'''Symmetry: Object
		'''
		self.symmetry.chk005.setChecked(False) #uncheck symmetry:topological
	...
	def chk005(self, state=None):
		'''Symmetry: Topo
		'''
		self.symmetry.chk004.setChecked(False) #uncheck symmetry:object space
		# if any ([self.symmetry.chk000.isChecked(), self.symmetry.chk001.isChecked(), self.symmetry.chk002.isChecked()]): #(symmetry)
