...
class Rendering(Init):
	def __init__(self, *args, **kwargs):
		...
		# comboBox = self.CheckableComboBox(self.rendering.cmb000)
		# for num in range(6):
	...
	def draggable_header(self, state=None):
		'''Context menu
		'''
		draggable_header = self.rendering.draggable_header
